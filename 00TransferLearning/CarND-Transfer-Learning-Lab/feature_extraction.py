...
def main(_):
    ...
    print('nb class :', nb_classes)
    # Here I find the number of classes for the dataset. 
    # np.unique returns all the unique elements of a numpy array.
    # The elements of y_train are integers, 0-9 for Cifar10 and 0-42 for
    # Traffic Signs. So, when combined with len we get back the number of
    # classes.

    # define model
    # Here I define a very simple model, a linear layer (Dense in Keras terms)
    # followed by a softmax activation. The Adam optimizer is used.
