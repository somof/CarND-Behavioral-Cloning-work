...
def main():
    ...
    if args.model_save_file:
        ...
        print(' ** save model:', args.model_save_file)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-mf', '--model_file', type=str, help='path to hd5 model file to load')
    parser.add_argument('-sf', '--model_save_file', type=str, help='path to hd5 model file to save')
